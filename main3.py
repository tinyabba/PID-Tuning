...
np.save("optimal_errors3.npy", all_errors)
...
np.save("optimal_errors3.npy", errors[optimal])
np.save("K_opt_idx_3", K_opt_idx)
np.save("K_opt_3", K_opt)
np.save("all_errors_3.npy", all_errors)
...
np.save("pid_tuning_errors3.npy", temp)
temp = np.zeros((n_trials, horizon, 3, 1))
np.save("pulled_arms_3.npy", temp)
...
np.save("pid_tuning_errors3.npy", errors[pidtuning])
